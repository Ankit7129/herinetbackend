...
router.get('/suggestions', authMiddleware, async (req, res) => {
    try {
      ...
      const interests = [...user.interests.predefined, ...user.interests.custom]; // Combine the arrays
  
      const suggestedProjects = await Project.find({
        tags: { $in: interests }, // Match the tags in both predefined and custom interests
      });
